...
describe('PosterMakerPage', () => {
  it('should render the poster form and canvas', async () => {
    ...
    expect(compiled.querySelector('h1')?.textContent).toContain('Tạo poster đơn tuyển');
  ...
  it('should restore the default poster content', async () => {
    await TestBed.configureTestingModule({
      imports: [PosterMakerPage],
    }).compileComponents();
